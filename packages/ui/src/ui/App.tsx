...
type Tab        = 'home' | 'system' | 'dashboards' | 'ai-designer' | 'src-nagios' | 'src-wazuh' | 'src-fortigate' | 'src-n8n' | 'src-otel' | 'src-suricata' | 'events' | 'metrics' | 'correlations' | 'alerts' | 'connectors' | 'admin';
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 10, marginBottom: 12, flexWrap: 'wrap' }}>
              ...
              <input value={genDesc} onChange={e => setGenDesc(e.target.value)}
                ...
                style={{
                  flex: 2, minWidth: 300, padding: '8px 12px', borderRadius: 8,
                  border: '1px solid rgba(255,255,255,.1)', background: '#0a0e1a',
                  color: '#e5e7eb', fontSize: 14,
                }}
              />
    ...
    <div>
      ...
      {showSmtp && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.6)' }} onClick={() => setShowSmtp(false)}>
          <div onClick={e => e.stopPropagation()} style={{ ...card({}), width: 440, maxWidth: '92vw', border: '1px solid rgba(167,139,250,0.3)' }}>
    ...
    <div style={{ marginBottom: 14, background: 'rgba(85,243,255,0.06)', border: '1px solid rgba(85,243,255,0.25)', borderRadius: 12, fontSize: 13, color: '#55f3ff' }}>
      ...
      {expanded && (
        <div style={{ padding: '0 18px 14px', display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' as const }}>
          <input value={key} onChange={e => setKey(e.target.value)} placeholder={t('license_key_placeholder')} style={{ ...S.input, flex: 1, minWidth: 200, fontFamily: 'monospace', fontSize: 12, padding: '8px 12px', boxSizing: 'border-box' as const }} />
...
function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#030711', fontFamily: 'Inter, system-ui, sans-serif', padding: 24 }}>
      <form onSubmit={handleSubmit} style={{ maxWidth: 400, width: '100%', padding: 40, borderRadius: 16, background: 'rgba(15,23,42,0.85)', border: '1px solid rgba(85,243,255,0.12)', backdropFilter: 'blur(24px)', textAlign: 'center' }}>
        <div style={{ fontSize: 48, marginBottom: 8 }}>&#x2B21;</div>
        <h1 style={{ fontSize: 22, fontWeight: 900, color: '#e9eeff', margin: '0 0 4px' }}>
